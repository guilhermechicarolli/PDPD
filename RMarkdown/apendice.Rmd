...
```{r, codigo, echo=TRUE, include = FALSE,results="hide", message = FALSE, warning = FALSE, eval=FALSE, error=FALSE, fig.cap = "Código da modelagem da distribuição potencial da espécie de planta. O código para a  mo delagem da distribuição do morcego é totalmente análogo."}
