...
![Importância relativa das variáveis para o modelo cheio da espécie *Echolirium subsecundum*](importancia_vars_planta.png){width="80%"}

![Importância relativa das variáveis para o modelo cheio da espécie *Lonchophylla bokermanni*](importancia_vars_morcego.png){width="80%"}
...
| Espécie                   | Ganho          | Perda | Sem alteração |
|---------------------------|----------------|-------|---------------|
| *Lonchophylla bokermanni* | RCP 4.5 (2050) | 0.67  | 37.65         |
|                           | RCP 8.5 (2050) | 0.06  | 58.12         |
| *Lonchophylla bokermanni* | RCP 4.5 (2050) | 0.08  | 72.78         |
|                           | RCP 8.5 (2050) | 0.00  | 81.11         |
...
+-------------------+--------------------------------+--------------------------------------------------------+-------------------------------------------------------+
| Cenário climático | Área de sobreposição ($km{2}$) | Sobreposição com relação à distribuição do morcego (%) | Sobreposição com relação à distribuição da planta (%) |
+===================+================================+========================================================+=======================================================+
| Presente          | 369410.9                       | 73.93                                                  | 71.94                                                 |
+-------------------+--------------------------------+--------------------------------------------------------+-------------------------------------------------------+
| RCP 4.5           | 119088.6                       | 38.44                                                  | 84.93                                                 |
+-------------------+--------------------------------+--------------------------------------------------------+-------------------------------------------------------+
| RCP 8.5           | 74409.3                        | 36.92                                                  | 76.70                                                 |
+-------------------+--------------------------------+--------------------------------------------------------+-------------------------------------------------------+
